...
#' @return \code{probability_gap}: RasterLayer depicting the probability gap.
#'   Written to disk as GeoTIFF.
#' @note This function is often called the 'confusion index', but has been
...
#'   refer to the number of times a soil class was predicted.
#' @param n_iterations Integer; the total number of model runs.
#' @param noise_cutoff Decimal; proportion of predictions to be considered
#'   'noise' and ignored. Allowable values range between 0 and 1.
#' @return Integer; the number of distinct soil classes predicted on the pixel
#'   (optionally, above a supplied threshold).
...
#'   \code{\link[dsmartr:eval_npred]{dsmartr::eval_npred()}}.
#' @examples \dontrun{
...
#' @param noise_cutoff Optional Decimal; proportion of predictions to be
#'   considered 'noise' and ignored. Acceptable values range between 0 and 1
#'   inclusive. Defaults to 0.
#' @return \code{n_classes_predicted}: RasterLayer depicting the number of
#'   distinct soils predicted per pixel more than \code{n_iterations *
#'   noise_cutoff} times. Written to disk as GeoTIFF.
#' @note Fewer classes predicted on a pixel generally indicates higher internal
#'   model confidence at that location.
#' @examples \dontrun{
...
#'
#' Checks existence of ties for most-probable soil and reports how many classes
#' are tied on a given pixel.
#' @keywords internal
#' @param input A vector of integers n soil classes long, where the integers
#'   refer to the number of times a soil class was predicted.
#' @param n_iterations Integer; the total number of model runs.
